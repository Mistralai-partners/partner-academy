# A4: Expected Rejection Outcome

What you should see when you Reject the disallowed send. These UI labels and the rejection message are grounded from the prior live capture of Vibe's approval flow.

## The approval prompt

When you ask Vibe to draft and send the heads-up message, it stops and shows the tool call and its arguments with three controls:
