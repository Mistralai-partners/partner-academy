# A4: Reference Automation (solution)
...
> `[VERIFY]` the exact dialog fields and pre-authorize control at capture. Frequency options and approval controls are grounded from the prior live capture.
