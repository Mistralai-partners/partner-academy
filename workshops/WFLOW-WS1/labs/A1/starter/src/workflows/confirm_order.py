"""A1 (starter): order-confirmation workflow.
...
Complete the one gap marked with a TODO below, then run the worker and trigger an
execution. Full steps are in TASKS.md.
"""
...
async def confirm_order(order_id: str, customer: str) -> str:
    ...
    # TODO: return the confirmation from the activity
    ...
