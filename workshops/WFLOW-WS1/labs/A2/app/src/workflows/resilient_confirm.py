"""WFLOW-WS1 A2 - resilient_confirm.
...
What this resilient version adds, and why:
...
The fault injector is provided by the lab and is not part of the resilience fix.
"""
...
# Provided by the lab; not part of the resilience fix you make.
